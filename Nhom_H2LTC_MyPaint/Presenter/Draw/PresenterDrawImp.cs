...
{
    public class PresenterDrawImp : PresenterDraw
    {
        ViewPaint viewPaint;
        ...
        public void handleClickToSelect(Point p)
        {
            ...
            else
            {
                ...
                dataManager.rectangleRegion = new System.Drawing.Rectangle(p, new Size(0, 0));
            }
        }
        ...
        public void onClickMouseMove(Point p)
        {
            ...
            else if (dataManager.isDrawingPen)
            {
                ...
                pen.points.Add(p);
                FindPoint.setPointHeadTail(pen);
                viewPaint.refreshDrawing();
            }
        ...
        private bool isInside(Model.Shape shape, Point p)
        {
            if (shape is MPen)
            {
        ...
        private void drawRegionForShape(Model.Shape shape, Graphics g)
        {
            if (shape is MLine)
            {
            ...
            else
            {
                ...
                })
                {
                    ...
                    viewPaint.setDrawingCurveSelected(FindPoint.getControlPoints(shape),
        ...
        public void onClickStopDrawing(MouseButtons mouse)
        {
            if (mouse == MouseButtons.Right)
            {
                if (dataManager.currentShape.Equals(CurrentShape.Polygon))
                {
                    ...
                    FindPoint.setPointHeadTail(polygon);
                }
                else if (dataManager.currentShape.Equals(CurrentShape.Curve))
                {
                    ...
                    FindPoint.setPointHeadTail(curve);
                }
            }
        }
